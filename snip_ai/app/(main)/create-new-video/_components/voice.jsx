  ...
  return (
    <div className="mt-3">
      ...
      <div className=" grid grid-cols-2 gap-3 mt-2">
        ...
        key={index}
          className={`cursor-pointer text-sm lg:text-lg p-2 dark:bg-slate-800 border-2 overflow-hidden rounded-lg ${selectedVoice==voiceOption.name ? 'border-blue-400':'border-slate-600 hover:border-white' }`}>
